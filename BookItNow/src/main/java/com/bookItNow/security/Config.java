        ...
        return http
                ...
                .authorizeHttpRequests(
                        ...
                        .requestMatchers( "/bookitnow/v1/users/delete/**","/bookitnow/v1/users/all",
                                ...
                                "/bookitnow/v1/sections/{sectionId}/capacity/{capacity}","/bookitnow/v1/sections/add/**","/bookitnow/v1/sections/delete/**",
                        ...
                        .requestMatchers("/bookitnow/v1/users/{userId}/seats/{seatId}/select",
                                "/bookitnow/v1/bookings/add/**","/bookitnow/v1/bookings/user/**","/bookitnow/v1/bookings/delete/**").hasRole("USER")

                        // Section and seat management accessible to all authenticated users
                        .requestMatchers("/bookitnow/v1/users/", "/bookitnow/v1/events/venue/","/bookitnow/v1/events/upcoming","/bookitnow/v1/events/available").hasAnyRole("ADMIN", "USER")
